...
namespace PostPocModel.UnitTests.CardSystem
{
    public class DeckTests
    {
        ...
        public void CreateHand_success() {
            Deck<MockCard>.Hand hand1 = target.CreateHand(0);
            Deck<MockCard>.Hand hand2 = target.CreateHand(1);
            Deck<MockCard>.Hand hand3 = target.CreateHand(2);
            Deck<MockCard>.Hand hand4 = target.CreateHand(3);
