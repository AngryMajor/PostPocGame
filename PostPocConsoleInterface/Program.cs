...
namespace PostPocConsoleInterface
{
    ...
    public class HandControler : IControler
    {
        ...
        private Deck<PostPocCard>.Hand<PostPocCard> myHand;

        public HandControler() {
            List<PostPocCard> StartingCards = new List<PostPocCard>() {
                new PostPocCard("First","First",x=>true,true),
                new PostPocCard("Second","First",x=>true,false),
                new PostPocCard("Third","First",x=>false,false),
                new PostPocCard("Fourth","First",x=>true,false),
                new PostPocCard("Fifth","First",x=>true,false),
                new PostPocCard("Sixth","First",x=>true,false),
                new PostPocCard("Seventh","First",x=>true,false),
                new PostPocCard("Eighth","First",x=>true,false),
                new PostPocCard("Ninith","First",x=>true,false),
                new PostPocCard("tenith","First",x=>true,false)
            };
        ...
        public Dictionary<string, Func<string[], string>> getCommands()
        {
            ...
            commands.TryAdd("play", delegate (string[] x) { myHand.TryPlay(int.Parse(x[0])); return ""; });
